...
// enum target_names {theta_s, Omega_dcdmdr, omega_dcdmdr, Omega_scf, f_ede_scf, Omega_ini_dcdm, omega_ini_dcdm, sigma8, S8}; //OR edited
/* Important: Keep this number equal to the number of target_names */
//define _NUM_TARGETS_ 8 //OR edited
enum target_names {theta_s_100, theta_s, Omega_dcdmdr, omega_dcdmdr, Omega_scf, f_ede_scf, Omega_ini_dcdm, omega_ini_dcdm, sigma8, S8};
